...
import com.philkes.notallyx.application.DatabaseSession
import com.philkes.notallyx.application.NoteApplicationService
import com.philkes.notallyx.application.RecordingNoteEffects
...
class NotesImporterTest {
    ...
    private fun testImport(
        ...
        runBlocking {
            NotesImporter(application, NoteApplicationService(application, DatabaseSession(application, { database }, {}), RecordingNoteEffects())).import(importSourceFile.toUri(), importSource)
